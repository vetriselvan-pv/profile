          ...
          >
            ...
            <div class="p-8">
              <div class="flex flex-wrap items-center gap-2 mb-4">
                ...
                <span
                  class="text-[10px] uppercase tracking-wider font-bold px-2.5 py-1 rounded-lg"
                  [class.bg-emerald-500/15]="project.visibility === 'Public'"
                  [class.text-emerald-400]="project.visibility === 'Public'"
                  [class.bg-rose-500/15]="project.visibility === 'Private'"
                  [class.text-rose-400]="project.visibility === 'Private'"
                >
                  {{ project.visibility }}
                </span>
              </div>
